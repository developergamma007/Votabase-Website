...
function requestLocation() {
  return new Promise((resolve, reject) => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      () => reject(new Error('Location permission is required to open voter info.')),
